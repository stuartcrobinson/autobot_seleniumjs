...
describe('Google Search 2222222', function () {
    ...
    it('demo2222222222', async function () {
        ...
        console.log("googlePage.testTitle: " + googlePage.testTitle);
        ...
        console.log("goo2 messag 1");
        await driver.sleep(1000);
        console.log("goo2 messag 2");
        await driver.sleep(1000);
        console.log("goo2 messag 3");
        await driver.sleep(1000);
        console.log("goo2 messag 4");
        await driver.sleep(1000);
    });
